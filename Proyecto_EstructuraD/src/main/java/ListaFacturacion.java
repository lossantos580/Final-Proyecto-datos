...
public class ListaFacturacion { //Colas
    ...
    public boolean Vacia3(){ // Nodo Datos Persona
        ...
        public void encolarDA(){
            ...
            da.setDatosAnimal(JOptionPane.showInputDialog("Ingrese los datos del animal: nombre/raza/sexo/detalle de cita: "));
            da.setEdad(Integer.parseInt(JOptionPane.showInputDialog("Ingrese la edad del animal(años): ")));
